...
YAHOO.ext.Element.prototype = {    
     ...
     */
    isVisible : function() {
        return YAHOO.util.Dom.getStyle(this.dom, 'visibility') != 'hidden' && this.isDisplayed();
    },
     ...
     */
     setSize : function(width, height, animate, duration, onComplete, easing){
        this.adjustWidth(width); this.adjustHeight(height);
        if(!animate || !YAHOO.util.Anim){
            this.setWidth(width);
    ...
    */
    clearOpacity : function(){
        ...
        if (isIE && typeof this.dom.style.filter == 'string') {
