# copied from cctools/scicom/scholars/trunk/scicom/scholars/agreements/support.py
...
def firstPageInfo (canvas, doc, title):
    ...
    drawFooter(canvas, title)

    canvas.restoreState()

def allPageInfo (canvas, doc, title):
    canvas.saveState()
...
#         pass
    ...
    canvas.drawString(0.6 * inch, inch*.5, title)
